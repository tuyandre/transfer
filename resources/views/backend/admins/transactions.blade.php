...
@section('content_target','Customer Transaction  List')
@section('action_buttons')
    <button type="button" class="btn btn-success  my-2 btn-icon-text" id="add_saving">
        <i class="fe fe-dollar-sign mr-2"></i> Add Agent Deposit
    </button>
@endsection
@section('contents')
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-1">Transaction List</h6>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Add Agent Deposit</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <div id="add-messages"></div>
                    <form action="{{route('admin.transactions.agentDeposit')}}" method="post" data-parsley-validate="" id="frmSave">
                        {{ csrf_field() }}
                        <div class="">
                        ...
                        <div class="modal-footer">
                            <button class="btn ripple btn-primary" id="btnSave">Save Agent Deposit</button>
...
@section('js')
    <script>
        ...
        var defaultUrl = "{{ route('admin.transactions.getClientTransaction') }}";
        var table;
                ...
                $.ajax({
                    ...
                    if (data.status == "ok") {
                        ...
                        $('#add-messages').html('<div class="alert alert-success flat">' +
                            ...
                            '<strong><i class="glyphicon glyphicon-ok-sign"></i></strong> Agent Deposit  successfully Saved. </div>');
