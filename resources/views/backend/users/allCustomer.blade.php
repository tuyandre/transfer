...
@section('content_target','Customer List')
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-1">Customers List</h6>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    ...
                    <form action="#" method="post" data-parsley-validate="" id="frmSave">
                        {{ csrf_field() }}
                        <div class="">
...
@section('js')
    <script>
        ...
        var defaultUrl = "{{ route('admin.users.getAllCustomer') }}";
        var table;
