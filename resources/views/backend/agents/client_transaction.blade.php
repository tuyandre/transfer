...
@section('content_target','Clients All Transaction')
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-1">Client Transaction</h6>
...
@section('js')
    <script>
        ...
        var defaultUrl = "{{ route('agent.clients.getClientTransaction') }}";
        var table;
