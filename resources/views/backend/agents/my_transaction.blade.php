...
@endsection
@section('content_title','Agent Transaction')
@section('content_target','My Transaction')
    ...
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-1">My Transaction Transaction</h6>
...
@section('js')
    <script>
        ...
        var defaultUrl = "{{ route('agent.auth.getMyTransaction') }}";
        var table;
